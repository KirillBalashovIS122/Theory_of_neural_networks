...
class SegmentationModel:
    def __init__(self, base_dir, image_size=(256, 256), batch_size=32, classes=None):
    ...
    def build_unet(self, input_size=(256, 256, 3)):
        ...
        u5 = Conv2D(256, 2, activation='relu', padding='same')(u5)
        u5 = concatenate([u5, c3])
        c5 = Conv2D(256, 3, activation='relu', padding='same')(u5)
        c5 = Conv2D(256, 3, activation='relu', padding='same')(c5)
        
        u6 = UpSampling2D((2, 2))(c5)
        u6 = Conv2D(128, 2, activation='relu', padding='same')(u6)
        u6 = concatenate([u6, c2])
        c6 = Conv2D(128, 3, activation='relu', padding='same')(u6)
        c6 = Conv2D(128, 3, activation='relu', padding='same')(c6)
        
        u7 = UpSampling2D((2, 2))(c6)
        u7 = Conv2D(64, 2, activation='relu', padding='same')(u7)
        u7 = concatenate([u7, c1])
        c7 = Conv2D(64, 3, activation='relu', padding='same')(u7)
        c7 = Conv2D(64, 3, activation='relu', padding='same')(c7)
        
        outputs = Conv2D(4, 1, activation='softmax', dtype='float32')(c7)
    ...
    def load_saved_model(self, model_name='model.keras'):
